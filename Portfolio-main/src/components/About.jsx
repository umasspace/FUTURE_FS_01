    ...
    <>
      <div className='relative overflow-hidden lg:overflow-visible'>
        ...
        <motion.p
          ...
          className='mt-4 text-secondary text-[14px] sm:text-[16px] md:text-[18px] max-w-3xl leading-[24px] sm:leading-[30px] font-semibold'
        >
          I bridge the gap between complex ideas and seamless digital experiences. As a specialist in TypeScript, React, and Three.js, I build high-performance applications that aren't just scalable—they’re immersive. Whether it’s architecting a robust Node.js backend or crafting 3D web experiences, I work closely with partners to turn vision into functional, elegant code.
        </motion.p>
